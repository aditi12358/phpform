...
<head>
    ...
    <title>Student Internship Form</title>
    <style>
        body {
...
<form action="home.php" method="post">
    ...
    <input type="text" name="ethnicity" id="">
    ...
    <input type="text" name="emergencycontact" id="">
    <label for="refinfo">Reference Info</label>
    <input type="text" name="refinfo" id="">
    <label for="availability">Availability</label>
    <input type="text" name="availability" id="">
    <label for="skills">Skills</label>
    <input type="text" name="skills" id="">
    <label for="disability">Disability</label>
    <input type="text" name="disability" id="">
